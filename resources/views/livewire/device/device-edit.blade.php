<div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Edit Device</h2>
    ...
    <form wire:submit.prevent="updateDevice" class="space-y-6">
        ...
        <div class="flex justify-end">
            ...
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Update Device</button>
        </div>
    </form>
</div>

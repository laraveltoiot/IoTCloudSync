<div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Edit Thing</h2>

    <form wire:submit.prevent="updateThing" class="space-y-6">
        <!-- Name -->
        <div>
        ...
        <div class="flex justify-end">
            ...
            <button type="submit"
                    ...
                    focus:outline-none focus:ring-2 focus:ring-blue-500">Update Thing</button>
        </div>
    </form>
</div>

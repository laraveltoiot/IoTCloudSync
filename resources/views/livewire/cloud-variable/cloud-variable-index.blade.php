    ...
    @if($showCreateModal)
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
                ...
                @livewire('variable.variable-create', ['thingId' => $thingId])
            </div>
        </div>
    @endif
    ...
    @if($showEditModal)
        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
                ...
                @livewire('variable.variable-edit', ['variableId' => $editVariableId])
            </div>
        </div>
    @endif
        ...
        @forelse($variables as $variable)
            <tr>
                ...
                <td class="py-4 pl-0 pr-4 text-right text-sm leading-6">
                    <a href="{{ route('variables.show', $variable->id) }}" class="text-blue-500 hover:underline mr-2">Show</a>
